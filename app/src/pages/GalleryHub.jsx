...
const CARDS = [
  { id: 'scene1', typeLabel: 'Scene 01', title: 'The Twin', icon: '🌕', target: 0, type: 'scene', gradient: 'linear-gradient(135deg, rgba(255,154,158,0.5) 0%, rgba(254,207,239,0.5) 100%)', glow: 'rgba(255,154,158,0.6)' },
  ...
  { id: 'sec8', typeLabel: 'Memory 08', title: 'Lunar\'s Diary', icon: '📖', target: 8, type: 'section', gradient: 'linear-gradient(135deg, rgba(94,231,223,0.5) 0%, rgba(180,144,202,0.5) 100%)', glow: 'rgba(180,144,202,0.6)' },
  ...
  { id: 'sec10', typeLabel: 'Memory 10', title: 'Birthday Wish Letter', icon: '📜', target: 10, type: 'section', gradient: 'linear-gradient(135deg, rgba(255,8,68,0.5) 0%, rgba(255,177,153,0.5) 100%)', glow: 'rgba(255,8,68,0.6)' }
];
